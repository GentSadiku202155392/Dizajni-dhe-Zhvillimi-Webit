...
<table class="table">
	<thead>
		...
		<th>Nr-Telefonit</th>
		<th>Gjinia</th>
        <th>Koha qe duhet siguruar gjaku</th>
        <th>GrupiGjakut</th>
        <th>Qyteti</th>
	</tr>
	</thead>
	<tbody>	
		...
		?>
                    ...
                    <td><a class="btn btn-info" href="Update-Kerkuesit.php?id=<?php echo $row['user_id']; ?>">Edit</a><br><br>
					&nbsp;<a class="btn btn-danger" href="Delete-Kerkuesit.php?user_id=<?php echo $row['user_id']; ?>">Delete</a><br><br>
