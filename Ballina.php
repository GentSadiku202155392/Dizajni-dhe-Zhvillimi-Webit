...
<head>
    ...
    <link rel="stylesheet" href="Ballinaa.css">
...
<br>
        ...
        <div class="container">
            ...
            <div class="video">
              <iframe width="560" height="315" src="Video/Video1.mp4" frameborder="0" allowfullscreen></iframe>
            </div>
          </div>
<br>
<br>
...
<div class="card card-1">
    ...
    <div class="card-header">
      <img src="Foto/Dhurogjak1.jpg" class="card-img" />
    </div>
  ...
  <div class="card card-2">
    <!-- card-header -->
    <div class="card-header">
      <img src="Foto/Dhurogjak2.jpg" class="card-img" />
    </div>
    <!-- card-header -->
  ...
  <div class="card card-3">
    <!-- card-header -->
    <div class="card-header">
      <img src="Foto/Dhurogjak3.jpg" class="card-img" />
    </div>
    <!-- card-header -->
