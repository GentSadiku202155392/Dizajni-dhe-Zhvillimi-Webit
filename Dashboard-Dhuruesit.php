                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td><a class="btn btn-info" href="Update-Dhuruesit.php?id=' . $row['user_id'] . '">Edit</a><br><br>
                                &nbsp;<a class="btn btn-danger" href="Delete-Dhuruesit.php?user_id=' . $row['user_id'] . '">Delete</a><br><br>
